...
var BaseLanguageModel = class extends BaseLangChain {
  ...
  static async deserialize(data) {
    ...
    const Cls = {
      openai: (await import("./openai-2SS7HCPK.js")).ChatOpenAI
    }[_type];
    if (Cls === void 0) {
...
var BaseChatModel = class _BaseChatModel extends BaseLanguageModel {
  ...
  async generate(messages, options, callbacks) {
    ...
    const results = await Promise.allSettled(baseMessages.map((messageList, i) => this._generate(messageList, { ...callOptions, promptIndex: i }, runManagers == null ? void 0 : runManagers[i])));
    const generations = [];
    const llmOutputs = [];
...
var ChatOpenAI = class extends BaseChatModel {
  ...
  constructor(fields, configuration) {
    ...
    this.organization = ((_a = fields == null ? void 0 : fields.configuration) == null ? void 0 : _a.organization) ?? getEnvironmentVariable("OPENAI_ORGANIZATION");
...
//# sourceMappingURL=chunk-Q44FCKKO.js.map
